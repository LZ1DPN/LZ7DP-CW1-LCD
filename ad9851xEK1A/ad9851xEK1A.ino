...
LiquidCrystal lcd(A5, A4, 13, 12, 7, 6);
...
// Initialize the Serial port so that we can use it for debugging
  Serial.begin(115200);
  Serial.println("Start VFO ver 20.0/2020");
...
void setincrement(){
  if(increment == 0){increment = 1; hertz = "1Hz"; hertzPosition=0;RITon=0;lcd.clear();} 
  else if(increment == 1){increment = 10; hertz = "10Hz"; hertzPosition=0;RITon=0;lcd.clear();}
  else if(increment == 10){increment = 50; hertz = "50Hz"; hertzPosition=0;RITon=0;lcd.clear();}
  else if (increment == 50){increment = 100;  hertz = "100Hz"; hertzPosition=0;RITon=0;lcd.clear();}
  else if (increment == 100){increment = 500; hertz="500Hz"; hertzPosition=0;RITon=0;lcd.clear();}
  else if (increment == 500){increment = 1000000; hertz="1Mhz"; hertzPosition=0;RITon=0;lcd.clear();} 
  else{increment = 0; hertz = "et RIT>"; hertzPosition=0; RITon=1;}  
...
//	lcd.clear();
    ...
    lcd.print(" Hz ");
	  lcd.setCursor(0,1);
//	lcd.print("                ");
	  lcd.print("S:");lcd.print(hertz);
	  lcd.setCursor(9,1); lcd.print("        ");
	  lcd.setCursor(9,1); lcd.print("R:"); lcd.print(rxRIT);
	  Serial.println(rx);
}
